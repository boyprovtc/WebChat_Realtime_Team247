...
import { setAvatatRoute } from "../utils/APIRoutes";
...
export default function SetAvatar() {
  ...
  const setProfilePicture = async () => {
    if (selectedAvatar === undefined) {
      toast.error("Please choose an avatar", toastOption);
    } else {
      const user = await JSON.parse(localStorage.getItem("chat-app-user"));
      const { data } = await axios.post(`${setAvatatRoute}/${user._id}`, {
      ...
      if (data.isSet) {
        ...
        toast.error("Set avatar failed. Please try again", toastOption);
      }
    }
  };
